...
This codes for multiprocess logging.
refernce: https://purplechip.tistory.com/46
'''
class Log():
        def __init__(self):
            self.th = None
        ...
        def listener_end(self, queue):
            """
            Ends the log listener thread by putting None in the queue and joining the thread.
            
            Args:
                queue (multiprocessing.Queue): The queue used for logging.
            """
            queue.put(None)
